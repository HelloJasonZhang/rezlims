...
const Filter = ({
  ...
  const { part_number, address } = filter
  ...
  return (
    <Row gutter={24}>
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
        {getFieldDecorator('part_number', { initialValue: part_number })(<Search placeholder="Search Part Number" size="large" onSearch={handleSubmit} />)}
      </Col>
      <Col {...ColProps} xl={{ span: 4 }} md={{ span: 8 }}>
